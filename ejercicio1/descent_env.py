...
class DescentEnv(gym.Env):
    ...
    def _get_reward(self):
        ...
        # Llegó a la pista
            ...
            if abs(self.altitude) < 5:  # Aterrizaje exitoso (altitud cerca de 0)
                reward = 100  # Recompensa grande
            else:  # Llegó a la pista pero no aterrizó bien
                reward = -50  # Penalización
